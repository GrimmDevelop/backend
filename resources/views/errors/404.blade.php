    ...
    <div class="container">
        <div class="row page">
            ...
            <div class="col-md-12 page-content">
                <p>Die angeforderte Ressource wurde nicht gefunden. Entweder wurde sie bereits aus der Datenbank
                    gelöscht oder es wurde eine falsche Aktion angefordert.</p>
                <h3>Möglichkeiten von hier</h3>
                <ul>
                    <li><a href="{{ route('dashboard') }}">Zurück zur Startseite</a></li>
