    <template>
        <div ref="container" class="relative w-full h-full p-10 overflow-hidden" @wheel.prevent="scroll" @mousedown.prevent="mouseDown" @mouseup="mouseUP" @mousemove="move">
        ...
        export default {
            ...
            methods: {
                ...
                centerImageNew() {
                    ...
                    const imageHeight = this.containerHeight * factor;

                    // TODO: calculate image height based on width

                    this.transformImage(100, (this.containerHeight - imageHeight) / 2, 1000 , imageHeight);
                    this.centerImage();
                },
