...
var update = __webpack_require__(37)("dfe0fb74", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_Typeahead_vue__ = __webpack_require__(39);
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    methods: {
        checkForChanges: function checkForChanges(event) {
            if (this.inputChanged && !confirm('Es wurden Felder im Formular geändert. ' + 'Möchtest du dieses wirklich verlassen?\n' + 'Alle Änderungen gehen verloren!')) {
                event.preventDefault();
        ...
        deleteRelation: function deleteRelation(bookId, relationType, person) {
            ...
            axios({
                ...
                if (!_this.inputChanged) {
                    location.reload(true);
                } else {
                    alert("Die Person wurde erfolgreich gelöscht. Die Änderung wird " + "erst bei einem Neuladen der Seite sichtbar.\n" + "Da Änderungen im Formular vorgenommen wurden, " + "wurde das automatische Neuladen unterbunden.");
                }
