...
Component.options.__file = "resources/assets/js/utils/Typeahead.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-86e23ff2", Component.options)
  } else {
    hotAPI.reload("data-v-86e23ff2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(43)("dfe0fb74", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-86e23ff2\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Typeahead.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-86e23ff2\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Typeahead.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['id', 'placeholder', 'src', 'onHit', 'prepareResponse', 'result', 'empty'],
    ...
    mounted: function mounted() {
        ...
        this.$nextTick(function () {
            _this.$refs.searchPerson.focus();
        });

        this.$watch('value', function (newValue, oldValue) {
            clearTimeout(___debouncer);

            ___debouncer = setTimeout(function () {
                axios.get(_this.src + encodeURIComponent(newValue)).then(function (_ref) {
                    var data = _ref.data;

                    _this.results = _this.preparation(data);
                    _this.searched = true;
                    _this.current = 0;
                });
            }, 500);
...
var render = function() {
  ...
  return _c("div", [
    _c("input", {
      ...
      attrs: { id: _vm.id, placeholder: _vm.placeholder, autocomplete: "off" },
      ...
      [
        _vm._l(_vm.results, function(item, index) {
          return _c(
            "li",
            {
              staticClass: "list-group-item typeahead-item",
            ...
            directives: [
              {
                name: "show",
                rawName: "v-show",
                value: _vm.searched && _vm.results.length == 0,
                expression: "searched && results.length == 0"
              }
            ],
            staticClass: "list-group-item"
          },
          [_c("span", { domProps: { innerHTML: _vm._s(_vm.empty) } })]
        )
      ],
      2
    )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-86e23ff2", module.exports)
  }
}
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__bootstrap__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_Typeahead_vue__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_Typeahead_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__utils_Typeahead_vue__);
...
new Vue({
    ...
    mounted: function mounted() {
        ...
        this.$nextTick(function () {
            if (PERSON_MODEL !== null) {
                _this.person = PERSON_MODEL;
            }

            $('#addOccurrence').on('shown.bs.modal', function (e) {
                _this.$refs.storeOccurrence.focus();
            });
        });
    },
    ...
    methods: {
        fillOccurrenceForm: function fillOccurrenceForm(person) {
    ...
    components: {
        typeahead: __WEBPACK_IMPORTED_MODULE_1__utils_Typeahead_vue___default.a
    }
});
