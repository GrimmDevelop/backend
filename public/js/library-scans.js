...
Component.options.__file = "resources/assets/js/utils/Upload.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5ff90a1e", Component.options)
  } else {
    hotAPI.reload("data-v-5ff90a1e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(43)("cb2b629e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5ff90a1e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Upload.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5ff90a1e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Upload.vue");
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__flowjs_flow_js__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__flowjs_flow_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__flowjs_flow_js__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        flowBindEvents: function flowBindEvents() {
            var _this = this;
            ...
            this.flow.on('fileProgress', function (file, event) {
                _this.uploadRunning = true;
        ...
        flowOpenFileDialog: function flowOpenFileDialog() {
            $(this.$refs.flowFileInput).click();
        },
        flowStartUpload: function flowStartUpload() {
            this.flow.upload();
        },
        ...
        progressBarStyle: function progressBarStyle(file) {
            return "width: " + file.progress + "%; min-width: 2em;";
        },
        progressBarClass: function progressBarClass(file) {
            if (file.state === 'error') {
  ...
  return _c(
    ...
    [
      _c(
        ...
        [_vm._t("header", [_vm._v("Datei(en) auswählen")])],
        2
      ),
      _vm._v(" "),
      _c("p", { staticClass: "btn-group" }, [
        ...
        _c(
          "button",
          {
            ...
            staticClass: "btn btn-primary",
            attrs: { type: "button", disabled: _vm.uploadCompleted },
            on: {
              click: function($event) {
                _vm.flowStartUpload()
              }
      ...
      _c(
        "ul",
        {
          ...
          staticClass: "upload__file-list"
        },
        _vm._l(_vm.files, function(file) {
          return _c("li", { staticClass: "upload__file-list__item" }, [
            _vm._v("\n            " + _vm._s(file.name) + "\n            "),
            _c("span", { staticClass: "upload__file-list__item__size" }, [
              _vm._v(
                "\n                " +
                  _vm._s(Math.round(file.size / 1024 * 10) / 10) +
                  "KB\n            "
              )
            ]),
            _vm._v(" "),
            _c(
                ...
                directives: [
                  {
                    name: "show",
                    rawName: "v-show",
                    value: _vm.uploadRunning,
                    expression: "uploadRunning"
                  }
                ],
              ...
              [
                _c(
                  "div",
                  {
                    class: _vm.progressBarClass(file),
                    style: _vm.progressBarStyle(file),
                    attrs: {
                      role: "progressbar",
                      "aria-valuenow": "0",
                      "aria-valuemin": "0",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5ff90a1e", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_Upload_vue__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_Upload_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__utils_Upload_vue__);
...
new Vue({
    ...
    components: {
        Upload: __WEBPACK_IMPORTED_MODULE_1__utils_Upload_vue___default.a
    }
});
